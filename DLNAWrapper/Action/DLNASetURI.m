...
- (instancetype)initWithURI:(NSString *)uri success:(void(^)(void))successBlock failure:(void(^)(NSError *))failureBlock
{
...
- (instancetype)initWithURI:(NSString *)uri useDefaultAudioMeta:(BOOL)flag success:(void (^)(void))successBlock failure:(void (^)(NSError *))failureBlock
{
...
- (instancetype)initWithURI:(NSString *)uri useDefaultVideoMeta:(BOOL)flag success:(void (^)(void))successBlock failure:(void (^)(NSError *))failureBlock
{
...
- (instancetype)initWithURI:(NSString *)uri metaData:(NSString *)metaData success:(void (^)(void))successBlock failure:(void (^)(NSError *))failureBlock
{
    self = [self init];
